...
import static BillboardServer.ServerLogic.CheckPermissions.checkBillboardPermissionsDeleteOrEdit;
    ...
    public static void createBillboard(){
        ...
        if (isSessionTokenValid(sessionTokenFromClient)) {
            ...
            if (billboard_id.equals("")) { // Create billboard because no billboard exists
                // Checks if the current user has the permission to create a billboard.
                if(!CheckPermissions.checkUserPermissions(sessionTokenFromClient, "createBillboard")){
                    optionalMessage = "User does not have permission to create billboards (need create_billboard permission)";
                    return;
                }
                ...
                if(!checkBillboardPermissionsDeleteOrEdit(billboard_id)){
                    return;
                }
